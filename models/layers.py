...
class ACM_GAT_Framework(nn.Module):
    def __init__(
            self, in_dim, out_dim, hidden_dim: int = 64,
            mix: bool = False, temprature: float = 3.0
    ):
        super().__init__()
        self.HP = ACM_GAT_Filter(in_dim, out_dim, filterbank="HP")
        self.LP = ACM_GAT_Filter(in_dim, out_dim, filterbank="LP")
        self.I = ACM_GAT_Filter(in_dim, out_dim, filterbank="I")
